...
if( isset( $_POST[ 'create_db' ] ) ) {
	...
	if( $DBMS == 'MySQL' ) {
		include_once BVWA_WEB_PAGE_TO_ROOT . 'bvwa/includes/DBMS/MySQL.php';
	}
	elseif( $DBMS == 'PGSQL' ) {
		// include_once BVWA_WEB_PAGE_TO_ROOT . 'bvwa/includes/DBMS/PGSQL.php';
		bvwaMessagePush( 'PostgreSQL is not currently suppported.' );
		bvwaPageReload();
	}
	else {
		bvwaMessagePush( 'ERROR: Invalid database selected. Review the config file' );
		bvwaPageReload();
	}
}
...
<div class=\"body_padded\">
	<h1>Database Setup <img src=\"" . BVWA_WEB_PAGE_TO_ROOT . "dvwa/images/spanner.png\" /></h1>

	<p>Click on the 'Create / Reset Database' button below to create or reset your datatbase <br />
	...
	<br />
	If you see disabled on either <i>allow_url_fopen</i> or <i>allow_url_include</i>, set the following in your php.ini file and restart your hosting(Most likely Apache).<br />
